	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-12"><br>
              <video width="100%" height="100%" poster="img/capavideos/3.jpg" controls>
...
<div id="depoimentos">
							...
							<div class="carousel-inner">
								<div class="item active">
									<div class="col-md-4 col-sm-6">
										...
										<a title="" href="#">IMERSÃO EM ANATOMIA CLÍNICA APLICADA</a>
										...
										<p><video width="100%" height="100%" poster="img/capavideos/5.jpg" controls>
   <source src="http://pvbps-sambavideos.akamaized.net/account/182/75/2018-08-13/video/5180ed74512ff400b224224f8295b32e/5180ed74512ff400b224224f8295b32e_1080p.mp4" type="video/mp4">
   <source src="movie.ogg" type="video/ogg">
   Your browser does not support the video tag.
</video> </p>
										...
										<img src="slider/img/testimonials/4.jpg" alt="" class="person img-circle" />
										<a title="" href="#">Pedro Luis Reis Crotti</a>
										<span>Prof. Dr. Cirurgião Torácico</span>
										</div>
									</div>
									<div class="col-md-4 col-sm-6">
										<div class="block-text rel zmin">
   ...
   Your browser does not support the video tag.
                                    ...
                                    <div class="col-md-4 col-sm-6">
										<div class="block-text rel zmin">
										<a title="" href="#">ENRIQUEÇA SEU CURRÍCULO</a>
											<div class="mark">Expectativa: <span class="rating-input"><span data-value="0" class="glyphicon glyphicon-star"></span><span data-value="1" class="glyphicon glyphicon-star"></span><span data-value="2" class="glyphicon glyphicon-star"></span><span data-value="3" class="glyphicon glyphicon-star"></span><span data-value="4" class="glyphicon glyphicon-star"></span><span data-value="5" class="glyphicon glyphicon-star"></span>  </span>
											</div>
										<p> <video width="100%" height="100%" poster="img/capavideos/3.jpg" controls>
   <source src="http://pvbps-sambavideos.akamaized.net/account/182/75/2018-08-13/video/b8f79d5767ef9dd7e0f6a3e9e2a2dd45/b8f79d5767ef9dd7e0f6a3e9e2a2dd45_1080p.mp4" type="video/mp4">
   <source src="movie.ogg" type="video/ogg">
   Your browser does not support the video tag.
</video>    	</p>
										<ins class="ab zmin sprite sprite-i-triangle block"></ins>
										...
										<div class="person-text rel text-light">
										<img src="slider/img/testimonials/5.jpg" alt="" class="person img-circle" />
										<a title="" href="#">Denise Maria Dotta Abech</a>
										<span>Profa. Dra. Endocrinologista e neuroendocrinologista</span>
										</div>
									</div>
...
<li>Traslados (Aeroporto <span  class="fa fa-arrow-right"></span> Hotel <span  class="fa fa-arrow-right"></span> Aeroporto)</li>
...
<br></div>
	...
	<form class="form" action="index.php#mensagem" method="POST" name="dados" onsubmit="return enviardados();">
	<div class="row">
		<div class="col-md-6">
...
if (isset($_POST['BTEnvia'])){
    ...
    //ANTISPAM - SE O CAMPO ANTISPAM ESTIVER PREENCHIDO NÃO EXECUTAR O RESTANTE DA PROGRAMAÇÃO
    if($_POST['email'] != ''){
		echo "BLOQUEADO POR PRÁTICA DE SPAM";
		exit;
	}
...
$spam=true;  
	...
	//REMETENTE --> ESTE EMAIL TEM QUE SER VALIDO DO DOMINIO
 	//====================================================
	$email_remetente = "contato@corpusanatomy.com.br"; // deve ser um email do dominio
	//====================================================
 
 
	//Configurações do email, ajustar conforme necessidade
	//====================================================
	$email_destinatario = "alberto.santana@kroton.com.br,marcelo.palmero@kroton.com.br,simone.wojcicki@kroton.com.br,isabel.chagas@kroton.com.br,caroline.f.santos@kroton.com.br,luis.almeida@kroton.com.br"; // qualquer email pode receber os dados
	$email_reply = "$e_mail";
	$email_assunto = "Pré-inscrição Medicina";
	//====================================================
	...
	$email_conteudo .= "Instituição = $Instituicao \n <br />"; 
	$email_conteudo .= "Curso = $Curso \n <br />"; 
	$email_conteudo .= "Ano = $Ano \n <br />";
	$email_conteudo .= "Período = $Periodo \n <br />";
	$email_conteudo .= "Mensagem = $Mensagem \n <br />";
	$email_conteudo .= "Pagamento = $Pagamento \n <br />";
 	//====================================================
  ...
  <hr>
    <p>Parabéns por escolher investir na sua formação. Estamos muito felizes pelo seu interesse e pela possibilidade de tê-lo em nosso grupo. Em breve entraremos em contato com você. Grande Abraço!</p>
